...
namespace Virgil.PFS.Session
{
    public class SecureSession
    {
        ...
        internal SecureSession(DateTime expiredAt, InitialMessageGenerator initialMessageGenerator)
        {
        ...
        public SecureSession(byte[] sessionId,
            byte[] encryptionKey,
            byte[] decryptionKey,
            byte[] additionalData,
            DateTime createdAt,
        ...
        public SecureSession(VirgilPFSSession session, DateTime expiredAt, InitialMessageGenerator initialMessageGenerator)
        {
            this.pfs.SetSession(session);
            this.initialMessageGenerator = initialMessageGenerator;
            this.expiredAt = expiredAt;
        ...
        //for initiator
        public SecureSession(VirgilPFSPublicKey recipientPfsPublicKey,
